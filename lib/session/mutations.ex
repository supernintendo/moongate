defmodule Moongate.Session.Mutations do
  @moduledoc """
    ...
    event process.
  """
  def mutate({:join_zone, zone_name, id}, event, state) do
  ...
  """
  def mutate({:leave_from, _origin}, event, state) do
  ...
  """
  def mutate({:set_target_zone, zone_module, id}, _event, _state) do
